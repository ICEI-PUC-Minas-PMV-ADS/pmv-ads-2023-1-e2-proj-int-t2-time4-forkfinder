                ...
                if (!context.Categorias.Any())
                {
                    context.Categorias.AddRange(new List<Categoria>()
                    {
                       ...
                       new Categoria ()
                       {
                           Nome= "Doces",
                           Descricao= "Lorem",
                           Imagem="https://ciadereceitas.com.br/wp-content/uploads/2022/08/churros-caseiro.png",
                           RestauranteId= 1
                       },
                       new Categoria ()
                       {
                           Nome= "Cafés",
                           Descricao= "Lorem",
                           Imagem="https://www.polodoscafes.com.br/wp-content/uploads/2020/05/10-curisoidades-sobre-o-caf%C3%A9-420x280_c.jpg",
                           RestauranteId= 2
                       },
                       new Categoria ()
                       {
                       ...
                       new Categoria ()
                       {
                           Nome= "Saladas",
                           Descricao= "Lorem",
                           Imagem="https://blog.supernosso.com/wp-content/uploads/2021/08/Como-temperar-uma-salada-opt.jpg",
                           RestauranteId= 3
                       },
                       new Categoria ()
                       {
                           Nome= "Brasa",
                           Descricao= "Lorem",
                           Imagem="https://obagastronomia.com.br/wp-content/uploads/2012/08/DSC05920.jpg",
                           RestauranteId= 4
                       },
                       new Categoria ()
                       {
                           Nome= "Frutos do Mar",
                           Descricao= "Lorem",
                           Imagem="http://www.contemporane.com.br/backend/timthumb/timthumb.php?src=backend/midias/imagens/30012019152037.png&w=750",
                           RestauranteId= 5
                       },
