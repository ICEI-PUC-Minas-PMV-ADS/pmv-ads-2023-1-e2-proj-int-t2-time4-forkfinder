                ...
                if (!context.Restaurantes.Any())
                {
                    context.Restaurantes.AddRange(new List<Restaurante>()
                    {
                        ...
                        }, new Restaurante()
                        {
                            ...
                            FotoPerfil = DownloadImageAsBytes("htts://th.bing.com/th/id/R.395f8b006a3bd0d07131fa7e99db8d45?rik=NzmyyrNQipPDKg&riu=http%3A%2F%2F50graphics.com%2Fwp-content%2Fuploads%2F2019%2F04%2FDifferent-logo-designs-for-Arabian-restaurant.jpg&ehk=XRlSiJsTVyKPAKtMMggXKOQGNLgKEJSVQpib3tJKWaw%3D&risl=&pid=ImgRaw&r=2000"),
                            DescricaoRestaurante = "Isto é uma descrição do restaurante Mangai Comida Regional"
                        },/*new Restaurante() {
