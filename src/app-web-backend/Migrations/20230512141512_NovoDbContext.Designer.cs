...
namespace fork_finder.Migrations
{
    ...
    [Migration("20230512141512_NovoDbContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoriaRestaurante", b =>
                {
                    b.Property<Guid>("CategoriasProdutoCategoriaId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("RestaurantesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CategoriasProdutoCategoriaId", "RestaurantesId");
            ...
            modelBuilder.Entity("CategoriaRestaurante", b =>
                {
                    b.HasOne("fork_finder.Models.Categoria", null)
                        .WithMany()
                        .HasForeignKey("CategoriasProdutoCategoriaId")
            ...
            modelBuilder.Entity("fork_finder.Models.Produto", b =>
                {
                    b.HasOne("fork_finder.Models.Categoria", "ProdutoCategoria")
                        .WithMany("Produtos")
